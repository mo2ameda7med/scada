...
//       clonedObj.set({
//         left: clonedObj.left + 20, // Add slight offset so it doesn't overlap perfectly
...
//       setDialogName(file.name.replace(/\.svg$/i, ""));
//       setDialogError("");
...
//         const activeObject = canvasEditor.getActiveObject();
//         if (activeObject) {
//           // Check if user is editing text inside object (Fabric behavior varies, safest to check)
